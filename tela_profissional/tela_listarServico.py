...
async def listarServico(page: ft.Page):
    ...
    async def criar_item_servico(servico):
        id_servico, nome, descricao, valor, total_avaliacoes, media = servico
                    ...
                    ft.Column([
                        ft.Row(
                            [
                                ...
                                ft.Container(
                                    content=ft.Text(value=f'R${valor:.2f}',
                                    color='black',
                                    size=16,
