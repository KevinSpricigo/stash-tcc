...
async def listar_jardineiros(page: ft.Page):
    ...
    try:
        ...
        if not profissionais.data:
            grid.content.controls.append(
                ft.Container(
                    content=ft.Text(
                        "Nenhum jardineiro disponível no momento.",
                        size=16,
                        color='black',
            ...
            if not grid.content.controls:
                grid.content.controls.append(
                    ft.Container(
                        content=ft.Text(
                            "Nenhum serviço cadastrado para os jardineiros disponíveis.",
                            size=16,
                            color='black',
                            text_align=ft.TextAlign.CENTER
                        ),
        ...
        print(f"Erro ao listar jardineiros: {e}")
        grid.content.controls.append(
            ft.Container(
                content=ft.Text(
